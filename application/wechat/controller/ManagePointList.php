...
class ManagePointList extends HomeAction
{
    ...
    public function refundOrder(Request $request)
    {
        ...
        $detail_ids     = $request->param("detail_id","");//订单内单品id,多个以逗号隔开
        ...
        if ($type){
            ...
            return $this->oneRefundOrder($pid,$detail_ids,$cancel_user,$cancel_reason,$trid);
        }
     ...
     * @throws \think\exception\DbException
     */
    protected function oneRefundOrder($pid,$detail_ids,$cancel_user,$cancel_reason,$trid)
    {
        ...
        foreach ($id_arr as $id){
            ...
            $order_amount += $dis_detail['price'] * $dis_detail['quantity'];
        }
        ...
        try{
                ...
                if ($dis_type){
                    ...
                    foreach ($dis_child_detail as $k => $v){
                        ...
                        $disParams_l = [
                            ...
                            "quantity"  => $v['quantity'],
                            "price"     => '-'.$v['price'],
                            "amount"    => '-'.$v['price'] * $dis_detail['quantity'],
                        ];
            ...
            $is_print = $this->refundToPrintYly($pid,$detail_ids);
